...
import { initBeatPolish, initSequenceScrub } from "../shared/initBeatPolish.js";

void Flip;
void ScrollToPlugin;

/**
 * V3 = GSAP story beats (primary) + compact Garage3D finale (Beat 10).
 */
export function initF1V3() {
  initBeatPolish();
  initF1V2({ skipGarage: true });
  initSequenceScrub("[data-f1-aero-seq]", "/sequences/f1-amr23");
